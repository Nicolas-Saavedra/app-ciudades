...
import { JwtTokenExpired, JwtTokenInvalid, JwtTokenIssuedAt, } from "hono/utils/jwt/types";
...
export const authnMiddleware = bearerAuth({
    ...
    invalidAuthenticationHeaderMessage: "You must be authenticated to perform this action",
    noAuthenticationHeaderMessage: "You must be authenticated to perform this action",
